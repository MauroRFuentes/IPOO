...
do{
    switch(menu()){
        case 1://Se cargan los datos del objeto manualmente
            ...
            for ($i=0;$i<4;$i++){
                ...
                $funcionTeatro[$i]["nombre"] = trim(fgets(STDIN));
                echo "Ingrese el precio de la misma: ";
                $funcionTeatro[$i]["precio"] = trim(fgets(STDIN));
            }
            echo "\n";
            
            $teatro = new Teatro($nombreTeatro,$direccionTeatro,$funcionTeatro);
          break;
        case 2: //Muestra por pantalla la informacion del Teatro
            echo $teatro."\n\n";
          break;
        case 3: //Opcion para cambiar el nombre del teatro.
            ...
            echo "\n";
          break;
        case 4: //Opcion para cambiar la direccion del teatro.
            ...
            echo "\n";
          break;
        case 5: //Opcion para cambiarle el nombre a una funcion.
            ...
            echo "\n";
          break;
        case 6: //Opcion para cambiar el precio de una funcion.
...
function menu(){
    echo "1) Cargar informacion del teatro.\n";
    echo "2) Ver informacion del teatro.\n";
    echo "3) Cambiar el nombre del teatro.\n";
    echo "4) Cambiar la direccion del teatro.\n";
    echo "5) Cambiar nombre de la funcion.\n";
    echo "6) Cambiar precio de una funcion.\n";
    echo "7) Salir.\n";
